...
01 a script that displays a confused smiley "(Ôo)'.
...
06  a script that displays the third line of the file iacta.
07 script that creates a file named exactly \*\\'"Best School"\'\\*$\?\*\*\*\*\*:) containing the text Best School ending by a new line.
08 script that writes into the file ls_cwd_content the result of the command ls -la. If the file ls_cwd_content already exists, it should be overwritten. If the file ls_cwd_content does not exist, create it.
09 a script that duplicates the last line of the file iacta
